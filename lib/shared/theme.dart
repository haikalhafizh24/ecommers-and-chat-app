...
Color cPrimaryColor = const Color(0xFF6C5ECF);
Color cGreenColor = const Color(0xFF38ABBE);
Color cRedColor = const Color(0xFFED6363);
Color cBlueColor = const Color(0xFF2C96F1);
...
Color cBgColor5 = const Color(0xFF2B2844);
Color cBgColor6 = const Color(0xFFECEDEF);
...
TextStyle whiteTextStyle = GoogleFonts.poppins(color: cWhiteColor);
...
TextStyle bgColor4TextStyle = GoogleFonts.poppins(color: cBgColor4);
