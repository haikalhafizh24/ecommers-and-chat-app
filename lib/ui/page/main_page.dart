            ...
            BottomNavigationBarItem(
              ...
              icon: Container(
                ...
                child: Image.asset(
                  ...
                  color: currentIndex == 0 ? cPrimaryColor : cGreyColor,
                  width: 22,
                ),
              ),
            ),
            BottomNavigationBarItem(
              ...
              icon: Container(
                ...
                child: Image.asset(
                  ...
                  color: currentIndex == 1 ? cPrimaryColor : cGreyColor,
                  width: 22,
                ),
              ),
            ),
            BottomNavigationBarItem(
              ...
              icon: Container(
                ...
                child: Image.asset(
                  ...
                  color: currentIndex == 2 ? cPrimaryColor : cGreyColor,
                  width: 22,
                ),
              ),
            ),
            BottomNavigationBarItem(
              ...
              icon: Container(
                ...
                child: Image.asset(
                  ...
                  color: currentIndex == 3 ? cPrimaryColor : cGreyColor,
                  width: 22,
                ),
              ),
            ),
